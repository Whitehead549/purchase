...
const Section = ({ fetchProducts }) => {
  const [activeSection, setActiveSection] = useState('products-ACCESSORIES'); // Default active section
  ...
  return (
    ...
    >
      <button
        onClick={() => handleButtonClick('products-ACCESSORIES')}
        className={`px-6 py-3 font-semibold rounded-lg transition duration-300 ${
          activeSection === 'products-ACCESSORIES'
